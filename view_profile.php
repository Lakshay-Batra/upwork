...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #292b2c;">
		<a class="navbar-brand" style="font-size:x-large; color: limegreen;" href="view_profile.php"><i class="fas fa-level-up-alt"></i> work (Profile)</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown trainings">
					<a href="update_user.php?u_id=<?php echo $_SESSION['id']; ?>" class="nav-link" style="color: white;"> Update_Profile </a>
				</li>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-5 xs-margin-30px-bottom">
					...
					<div class="bg-light-gray padding-30px-all md-padding-25px-all sm-padding-20px-all text-center">
						...
						<button class="btn btn-success"><a href="update_user.php" style="color: white; text-decoration:none;"> Update </a> </button>
					</div>
				...
				<div class="col-lg-8 col-md-7">
					<div class="team-single-text padding-50px-left sm-no-padding-left">
						<h4 class="font-size38 sm-font-size32 xs-font-size30"><?php echo $_SESSION['firstname']; ?></h4>
